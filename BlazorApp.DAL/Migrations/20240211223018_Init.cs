        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeToPass = table.Column<double>(type: "REAL", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "INTEGER", nullable: false),
                    QuizId = table.Column<int>(type: "INTEGER", nullable: false),
                    ResultMark = table.Column<double>(type: "REAL", nullable: false),
                    CountOfCorrectAnswers = table.Column<int>(type: "INTEGER", nullable: false),
                    CountOfIncorrectAnswers = table.Column<int>(type: "INTEGER", nullable: false),
                    JoinedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    FinishedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersResults", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UsersResults_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UsersResults_Quizzes_QuizId",
                        column: x => x.QuizId,
                        principalTable: "Quizzes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoursesQuizzes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CoursesQuizzes_CourseLesson_LessonId",
                        column: x => x.LessonId,
                        principalTable: "CourseLesson",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CoursesQuizzes_Quizzes_QuizId",
                        column: x => x.QuizId,
                        principalTable: "Quizzes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CoursesQuizzes_LessonId",
                table: "CoursesQuizzes",
                column: "LessonId");

            migrationBuilder.CreateIndex(
                name: "IX_CoursesQuizzes_QuizId",
                table: "CoursesQuizzes",
                column: "QuizId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsersResults_QuizId",
                table: "UsersResults",
                column: "QuizId");

            migrationBuilder.CreateIndex(
                name: "IX_UsersResults_UserId",
                table: "UsersResults",
                column: "UserId");
